            ...
            <h1>Aras Kargo Fatura</h1>
					<div class="form-group m-form__group">
                      ...
                      <input name="submit" type="submit" value="İşlam Başlat" id="OrderClick" class="btn btn-primary form-contol inline m-input m-input--air">
                           	<button value="İşlam Başlat" id="krediBTN" class="btn btn-primary form-contol inline m-input m-input--air">Kredi İşlam Başlat</button>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    $('#OrderForm').submit(function (event) {
      ...
      var url = "<?=$faturacontrol?>/ArasFatura.php";
    ...
    $('#krediBTN').click(function (event) {
      var form = $("#OrderForm");
      var invoiceNumber = $("#invoiceNumber").val();
      var invoiceSeri = $("#invoiceSeri").val();
      var StartDate = $("#StartDate").val();
      var StartTime = $("#StartTime").val();
      var url = "<?=$faturacontrol?>/ArasFaturaKREDI.php";
      // Stop the browser from submitting the form.
      event.preventDefault();
      // Serialize the form data.
      var formData = $("#OrderForm").serialize();
